...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DGow2wUs.mjs';
import { manifest } from './manifest_UuZg9mmt.mjs';
...
const _args = {
    "middlewareSecret": "1af9aea4-be72-4b45-adbc-9219353f6dac",
