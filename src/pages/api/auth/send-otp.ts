...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    const emailPass = import.meta.env.EMAIL_PASSWORD;//your-16-char-app-password # ✅ App password for sender email
    const emailFrom = import.meta.env.EMAIL_FROM || '"Your App" <noreply@yourapp.com>';//“From” address users see
    ...
    if (user) {
      ...
      if (!import.meta.env.DEV && emailUser && emailPass) {
